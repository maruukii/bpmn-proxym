...
Logger.pretty = function (type = 'primary', title:string, text:string) {
  if (typeof text === 'object') {
...
Logger.prettyPrimary = function (title:string, ...text:[string]) {
  text.forEach((t) => this.pretty('primary', title, t))
}

Logger.prettySuccess = function (title:string, ...text:[string]) {
  text.forEach((t) => this.pretty('success', title, t))
}

Logger.prettyWarn = function (title:string, ...text:string[]) {
  text.forEach((t) => this.pretty('warn', title, t))
}

Logger.prettyError = function (title:string, ...text:string[]) {
  text.forEach((t) => this.pretty('error', title, t))
}

Logger.prettyInfo = function (title:string, ...text:string[]) {
